...
$sql = "SELECT A . * , B.DuongDan, C.TenNhaSX FROM tbl_sanpham A INNER JOIN tbl_hinhanh B INNER JOIN tbl_nhasx C ON C.MaNhaSX = A.MaNhaSX AND A.MaSP = B.MaSP LIMIT $start,$display";
...
?><?php
            ...
            if ($set['SPMoi'] == 1 || $set['KhuyenMai'] == 1) {
